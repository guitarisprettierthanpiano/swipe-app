...
const Hourly: React.FC<Props> = (props) => {
    ...
    className='hourly-container'>
        ...
        <div className='hourly-subcontainer'>
            ...
            <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[0]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[1]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[2]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[3]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[4]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[5]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[6]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[7]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
            <span className='hourly-hours'>{props.hourly_hours[8]}</span>
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[8]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[9]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[10]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[11]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[12]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[13]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[14]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[15]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[16]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[17]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[18]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[19]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[20]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[21]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[22]}@4x.png`} alt='hourly-weather-icon'></img>
        ...
        <div className='hourly-subcontainer'>
                ...
                <img className='hourly-img' src={`https://openweathermap.org/img/wn/${props.hourly_icon[23]}@4x.png`} alt='hourly-weather-icon'></img>
